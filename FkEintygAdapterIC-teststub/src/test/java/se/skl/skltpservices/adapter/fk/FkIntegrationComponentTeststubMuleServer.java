...
public class FkIntegrationComponentTeststubMuleServer {

	private static final Logger logger = LoggerFactory.getLogger(FkIntegrationComponentTeststubMuleServer.class);

	private static final RecursiveResourceBundle rb = new RecursiveResourceBundle("FkIntegrationComponent-config");

	public static final String MULE_SERVER_ID = "FkIntegrationComponent-teststub";
