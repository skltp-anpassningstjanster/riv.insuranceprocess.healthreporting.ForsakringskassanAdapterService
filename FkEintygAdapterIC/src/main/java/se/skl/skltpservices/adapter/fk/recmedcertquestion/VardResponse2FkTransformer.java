	...
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
		...
		try {
			...
			if (faultDetected) {
				...
				marshaller.marshal(new JAXBElement(new QName("urn:riv:fk:vardgivare:sjukvard:TaEmotFraga:1:rivtabp20",
						"TaEmotFragaResponse"), TaEmotFragaResponseType.class, outResponse), writer);
