	...
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
		...
		try {
			...
			if (faultDetected && !validationErrorDetected) {
				...
				Marshaller marshaller = JAXBContext.newInstance(SendMedicalCertificateAnswerResponseType.class)
						.createMarshaller();
				marshaller.marshal(new JAXBElement(new QName(
						"urn:riv:insuranceprocess:healthreporting:SendMedicalCertificateAnswerResponder:1",
						"SendMedicalCertificateAnswerResponse"), SendMedicalCertificateAnswerResponseType.class,
						outResponse), writer);
