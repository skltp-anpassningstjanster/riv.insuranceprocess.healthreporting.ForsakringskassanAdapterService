...
public class FkResponse2VardTransformer extends AbstractMessageTransformer {
	...
	private static final JaxbUtil JAXB_UTIL = new JaxbUtil(SendMedicalCertificateAnswerResponseType.class);
	...
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
		...
		try {
			...
			if (faultDetected && !validationErrorDetected) {
				...
				String payload = JAXB_UTIL.marshal(outResponse, "urn:riv:insuranceprocess:healthreporting:SendMedicalCertificateAnswerResponder:1", "SendMedicalCertificateAnswerResponse");
