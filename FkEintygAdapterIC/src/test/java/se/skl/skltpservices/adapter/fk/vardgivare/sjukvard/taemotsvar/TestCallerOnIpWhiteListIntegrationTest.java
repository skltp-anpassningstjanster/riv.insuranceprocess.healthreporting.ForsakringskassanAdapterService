...
public class TestCallerOnIpWhiteListIntegrationTest extends AbstractTestCase {
	
	
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(TestCallerOnIpWhiteListIntegrationTest.class);
	...
	public TestCallerOnIpWhiteListIntegrationTest() {
	...
	protected String getConfigResources() {
		return "soitoolkit-mule-jms-connector-activemq-embedded.xml,"+
				"test-caller-on-ip-whitelist/ip-whitelist-FkIntegrationComponent-common.xml," +
	...
	@Test
	public void testCallerIsNotOnIpAdressWhiteListWhenUsingHttpEndpoint() throws Exception {
		...
		try {
			...
			assertTrue(ex.getMessage().contains("FKADAPT002 Caller was not on the white list of accepted IP-addresses. IP-address:"));
		}
	}
}
